...
def test_read_rejects_image_assets_without_marking_them_used(isolated_data_root):
    import base64
    from character_workflow.lib.creation_assets import create_media_asset_from_bytes, get_creation_asset
    png = base64.b64decode(
        "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII="
    )
    image = create_media_asset_from_bytes(title="图", body=png, filename="a.png", mime_type="image/png", tags=[])
