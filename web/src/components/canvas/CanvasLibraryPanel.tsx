  ...
  return (
    <>
      <aside
        ...
        className="canvas-library-panel absolute bottom-3 left-16 top-20 z-20 flex w-[min(22rem,calc(100vw-5rem))] flex-col overflow-hidden rounded-xl border border-border bg-popover shell-glow md:left-20 md:top-24"
      >
